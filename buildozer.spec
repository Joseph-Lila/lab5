...
source.exclude_dirs = tests, bin, venv, .buildozer, .git, .idea
...
# (list) Permissions
android.permissions = INTERNET, VIBRATE, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION
